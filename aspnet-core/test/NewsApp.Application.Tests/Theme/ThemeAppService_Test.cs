...
namespace NewsApp.Theme
{
    public class ThemeAppService_Test : NewsAppApplicationTestBase
    {
        ...
        {
            //Arrange            
            var input = new CreateThemeDto { Name = "nuevo tema" };
        ...
        {
            //Arrange            
            var input = new CreateThemeDto { Name = "nuevo tema", Id = 1 };
        ...
        {
            //Arrange            
            var input = new CreateThemeDto { Name = "nuevo tema hijo", ParentId = 1 };
